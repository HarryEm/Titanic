...
rf100 <- randomForest(factor(Survived) ~ .,
                        data = subset(dftemp[,!names(dftemp) %in% c("Farebracket","HasCabin")],dftemp$Missing=="100"))
...
There are no training examples for the 100 example in the test set; as its one example I will just use the imputed value for HasCabin and Fare and treat it the same as the 111 model.
